...
class SpanModelPredictor(Predictor):
    ...
    def predict_instance(self, instance):
        ...
        try:
            ...
            #print(model.vocab.get_namespaces())
            #{0: 'NEG', 1: 'POS'}
            #print(model.vocab._index_to_token["None__relation_labels"])
            #print(model.vocab._index_to_token["None__ner_labels"])
            #print(model.vocab._index_to_token["None__tag_labels"])
            #print("+" * 50)
